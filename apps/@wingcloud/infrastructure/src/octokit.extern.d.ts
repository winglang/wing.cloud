export default interface extern {
  octokit: (baseDir: string) => Promise<OctoKit>,
}
export interface OctoKitApps {
}
export interface OctoKitGit {
}
export interface OctoKitIssues {
}
...
export interface OctoKitPulls extends IResource {
}
export interface OctoKitRepos extends IResource {
}
export interface OctoKit {
  readonly apps: OctoKitApps;
  readonly git: OctoKitGit;
  readonly issues: OctoKitIssues;
  readonly pulls: OctoKitPulls;
  readonly repos: OctoKitRepos;
}