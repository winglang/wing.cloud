export default interface extern {
  createProbot: (appId: string, privateKey: string, webhookSecret: string) => Promise<ProbotInstance>,
}
...
export interface IProbotAuth extends IResource {
}
export interface IProbotWebhooks extends IResource {
}
