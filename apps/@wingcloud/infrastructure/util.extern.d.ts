export default interface extern {
  addMiliseconds: (date: string, ms: number) => Promise<string>,
  encodeURIComponent: (value: string) => Promise<string>,
  parseLog: (log: string) => Promise<(Log) | undefined>,
  replaceAll: (value: string, regex: string, replacement: string) => Promise<string>,
  toResource: (o: IConstruct) => Dummy,
}
...
export class Dummy extends Resource {
}